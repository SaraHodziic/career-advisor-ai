def calculate_resume_strength(resume_text):
    """
    Calculate a resume quality score from predefined content criteria.

    Returns:
        tuple[int, list[tuple[str, int]], str]: Score, criterion breakdown,
        and quality level.
    """
    ...
    for section in sections:
        if section in resume_lower:
            strength_score += 10
            breakdown.append((section.capitalize(), 10))
        else:
            breakdown.append((section.capitalize(), 0))
